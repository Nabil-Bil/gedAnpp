    ...
    <DataTable stripedRows editMode="row" @cell-edit-complete="onRowEditSave" class="editable-cells-table w-full"
      ...
      <template #header>
        <div class="flex justify-between">
          <div>
            <span class="px-2">
              <Button type="button" icon="pi pi-plus" label="Add" class="p-button-primary" @click="addNewMedication"
                :disabled="!isDisabled" />
            </span>
            <span class="px-2">
              <Button type="button" icon="pi pi-trash" label="Delete" class="p-button-danger" @click="destroyMedication"
                :disabled="isDisabled" />
            </span>
            <span class="px-2">
      ...
      <Column header="Pharmaceutical Establishment" style="width: 10%; text-align: center"
        ...
        <template #editor="{ data, field }">
          <Dropdown v-model="data[field]" :options="pharmaceutical_establishments" optionLabel="name"
            placeholder="Select New Pharmaceutical Establishments" :filter="true"
